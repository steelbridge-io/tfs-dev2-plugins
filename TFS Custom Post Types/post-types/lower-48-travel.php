...
function lower_forty_eight() {
  
  $labels = array(
    'name'                  => _x( 'Lower 48 Posts', 'Post Type General Name', 'lower_fourtyeight_domain' ),
    'singular_name'         => _x( 'Lower 48 Post', 'Post Type Singular Name', 'lower_fourtyeight_domain' ),
    'menu_name'             => __( 'Lower 48 Posts', 'lower_fourtyeight_domain' ),
    'name_admin_bar'        => __( 'Lower 48 Post', 'lower_fourtyeight_domain' ),
    ...
    'all_items'             => __( 'All Lower 48 Posts', 'lower_fourtyeight_domain' ),
...
add_action( 'init', 'lower_forty_eight', 0 );
