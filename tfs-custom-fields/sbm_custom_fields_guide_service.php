...
function tfs_guideservice_meta_callback($post) {
    ...
    <p> <!-- Check box acitvates readmore secition for seasons -->
      
    <div class="guide-row-content">
    <label for="guide-readmore-option">
    <input type="checkbox" name="guide-readmore-option-checkbox" id="guide-readmore-option-checkbox" value="yes" <?php if ( isset ($tfs_stored_guideservice_meta['guide-readmore-option-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['guide-readmore-option-checkbox'][0], 'yes' ); ?> />
    <?php _e('Check to activate read-more content area.'); ?>
    </label>
    </div>
    ...
    <!-- ==== Autumn season checkbox ==== -->

		<p>

		<span class="guide-row-title"><?php _e( '<strong>Display autumn season</strong>', 'tfs-guideservice-textdomain' )?></span>
		<div class="guide-row-content">
		<label for="guide-optionfall-checkbox">
		<input type="checkbox" name="guide-optionfall-checkbox" id="guide-optionfall-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['guide-optionfall-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['guide-optionfall-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate autumn/fall.', 'tfs-guideservice-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <!-- ==== Winter Season ==== -->
		...
		<span class="guide-row-title"><?php _e( '<strong>Display winter season</strong>', 'tfs-guideservice-textdomain' )?></span>
		<div class="guide-row-content">
		<label for="guide-optionwinter-checkbox">
		<input type="checkbox" name="guide-optionwinter-checkbox" id="guide-optionwinter-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['guide-optionwinter-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['guide-optionwinter-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate winter season.', 'tfs-guideservice-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <!-- ==== Spring Season ==== -->
		...
		<span class="guide-row-title"><?php _e( '<strong>Display spring season</strong>', 'tfs-guideservice-textdomain' )?></span>
		<div class="guide-row-content">
		<label for="guide-optionspring-checkbox">
		<input type="checkbox" name="guide-optionspring-checkbox" id="guide-optionspring-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['guide-optionspring-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['guide-optionspring-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate spring season.', 'tfs-guideservice-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <!-- ==== Summer Season ==== -->
		...
		<span class="guide-row-title"><?php _e( '<strong>Display summer season</strong>', 'tfs-guideservice-textdomain' )?></span>
		<div class="guide-row-content">
		<label for="guide-optionsummer-checkbox">
		<input type="checkbox" name="guide-optionsummer-checkbox" id="guide-optionsummer-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['guide-optionsummer-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['guide-optionsummer-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate summer season.', 'tfs-guideservice-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <p><!-- Feature #3 Fishing -->
      ...
      <input style="width: 100%;" type="text" name="feature-gs3-fishing-title" id="feature-gs3-fishing-title" value="<?php if ( isset ( $tfs_stored_guideservice_meta['feature-gs3-fishing-title'] ) ) echo $tfs_stored_guideservice_meta['feature-gs3-fishing-title'][0]; ?>" />
		...
		<label for="feature-gs3-fishing-readmore-checkbox">
		<input type="checkbox" name="feature-gs3-fishing-readmore-checkbox" id="feature-gs3-fishing-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['feature-gs3-fishing-readmore-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['feature-gs3-fishing-readmore-checkbox'][0], 'yes' ); ?> />
   ...
   <!-- FEATURE #5 LODGING -->
    ...
    <!-- ==== Display read more==== -->
		...
		<div class="guideservice-row-content">
		<label for="feature-gs3-readmore-checkbox">
		<input type="checkbox" name="feature-gs3-readmore-checkbox" id="feature-gs3-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_guideservice_meta['feature-gs3-readmore-checkbox'] ) ) checked( $tfs_stored_guideservice_meta['feature-gs3-readmore-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate read more.', 'tfs-guideservice-textdomain' )?>
		</label>
		</label>
		</div>
