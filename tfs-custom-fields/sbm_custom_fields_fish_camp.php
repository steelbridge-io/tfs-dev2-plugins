...
function tfs_fish_camp_meta_callback($post) {
    ...
    <!-- ==== Display read more==== -->
		...
		<span class="fishcamp-row-title"><?php _e( '<strong>Display read more section</strong>', 'tfs-fish-camp-textdomain' )?></span>
		<div class="fishcamp-row-content">
		<label for="fishcamp-dates-readmore-checkbox">
		<input type="checkbox" name="fishcamp-dates-readmore-checkbox" id="fishcamp-dates-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_fish_camp_meta['fishcamp-dates-readmore-checkbox'] ) ) checked( $tfs_stored_fish_camp_meta['fishcamp-dates-readmore-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate read more.', 'tfs-fish-camp-textdomain' )?>
		</label>
		</label>
		</div>
   ...
   <!-- FEATURE #4 LODGING -->
    ...
    <!-- ==== Display read more==== -->
		...
		<span class="fishcamp-row-title"><?php _e( '<strong>Display read more section</strong>', 'tfs-fish-camp-textdomain' )?></span>
		<div class="fishcamp-row-content">
		<label for="fishcamp-lodging-readmore-checkbox">
		<input type="checkbox" name="fishcamp-lodging-readmore-checkbox" id="fishcamp-lodging-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_fish_camp_meta['fishcamp-lodging-readmore-checkbox'] ) ) checked( $tfs_stored_fish_camp_meta['fishcamp-lodging-readmore-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate read more.', 'tfs-fish-camp-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <!-- ==== Display read more==== -->
		...
		<span class="fishcamp-row-title"><?php _e( '<strong>Display Getting To section</strong>', 'tfs-fish-camp-textdomain' )?></span>
		<div class="fishcamp-row-content">
		<label for="fishcamp-gettingto-readmore-checkbox">
		<input type="checkbox" name="fishcamp-gettingto-readmore-checkbox" id="fishcamp-gettingto-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_fish_camp_meta['fishcamp-gettingto-readmore-checkbox'] ) ) checked( $tfs_stored_fish_camp_meta['fishcamp-gettingto-readmore-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate read more.', 'tfs-fish-camp-textdomain' )?>
		</label>
		</label>
		</div>
    ...
    <!-- ==== Display read more==== -->
		...
		<span class="fishcamp-row-title"><?php _e( '<strong>Display Getting To section</strong>', 'tfs-fish-camp-textdomain' )?></span>
		<div class="fishcamp-row-content">
		<label for="fishcamp-itinerary-readmore-checkbox">
		<input type="checkbox" name="fishcamp-itinerary-readmore-checkbox" id="fishcamp-itinerary-readmore-checkbox" value="yes" <?php if ( isset ( $tfs_stored_fish_camp_meta['fishcamp-itinerary-readmore-checkbox'] ) ) checked( $tfs_stored_fish_camp_meta['fishcamp-itinerary-readmore-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box to activate read more.', 'tfs-fish-camp-textdomain' )?>
		</label>
		</label>
		</div>
