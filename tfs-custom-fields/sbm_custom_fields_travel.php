...
function tfs_custom_travel_meta() {
    ...
    if(!empty($post)){
        ...
        if($pageTemplate == 'page-templates/travel-template.php') {
            $types = array('post', 'page', 'travel_cpt');
            ...
            <div class="panel-body boof">
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active" id="basicseason">
                        ...
                        <!-- ==== Add Basic Season Section ==== -->
                        <p>

                            <span class="travel-row-title"><?php _e( '<strong>Display Basic Fishing Seasons</strong>', 'tfs-travel-textdomain' )?></span>
                        <div class="travel-row-content">
                            <label for="basic-season-checkbox">
                                <input type="checkbox" name="basic-season-checkbox" id="basic-season-checkbox" value="yes" <?php if ( isset ( $sbm_stored_travel_meta['basic-season-checkbox'] ) ) checked( $sbm_stored_travel_meta['basic-season-checkbox'][0], 'yes' ); ?> />
                                <?php _e( 'Check box to activate Basic Season.', 'tfs-travel-textdomain' )?>
                            </label>
                            </label>
                        </div>
