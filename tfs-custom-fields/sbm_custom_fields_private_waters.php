      ...
      <input style="width: 100%;" type="text" name="feature-pw3-fishing-title" id="feature-pw3-fishing-title" value="<?php if ( isset ( $tfs_stored_private_meta['feature-pw3-fishing-title'] ) ) echo $tfs_stored_private_meta['feature-pw3-fishing-title'][0]; ?>" />
		...
		<div class="panel with-nav-tabs panel-default">
			...
			<div class="panel-body boof">
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Section</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-section-checkbox">
				<input type="checkbox" name="fishing-section-checkbox" id="fishing-section-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-section-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-section-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing section.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;1</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat1-checkbox">
				<input type="checkbox" name="fishing-beat1-checkbox" id="fishing-beat1-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat1-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat1-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;1.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;2</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat2-checkbox">
				<input type="checkbox" name="fishing-beat2-checkbox" id="fishing-beat2-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat2-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat2-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;2.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;3</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat3-checkbox">
				<input type="checkbox" name="fishing-beat3-checkbox" id="fishing-beat3-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat3-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat3-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;3.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;4</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat4-checkbox">
				<input type="checkbox" name="fishing-beat4-checkbox" id="fishing-beat4-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat4-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat4-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;4.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;5</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat5-checkbox">
				<input type="checkbox" name="fishing-beat5-checkbox" id="fishing-beat5-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat5-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat5-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;5.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
				...
				<span class="private-row-title"><?php _e( '<strong>Display Fishing Beat &#35;6</strong>', 'tfs-private-textdomain' )?></span>
				<div class="private-row-content">
				<label for="fishing-beat6-checkbox">
				<input type="checkbox" name="fishing-beat6-checkbox" id="fishing-beat6-checkbox" value="yes" <?php if ( isset ( $tfs_stored_private_meta['fishing-beat6-checkbox'] ) ) checked( $tfs_stored_private_meta['fishing-beat6-checkbox'][0], 'yes' ); ?> />
				<?php _e( 'Check box to activate fishing beat &#35;6.', 'tfs-private-textdomain' )?>
				</label>
				</label>
				</div>
