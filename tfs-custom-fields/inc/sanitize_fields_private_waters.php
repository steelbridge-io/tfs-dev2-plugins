...
function sbm_private_meta_save( $post_id ) {
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-section-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-section-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-section-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat1-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat1-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat1-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat2-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat2-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat2-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat3-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat3-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat3-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat4-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat4-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat4-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat5-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat5-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat5-checkbox', '' );
		}
	...
	// Checks for input and displays fishing section
		if( isset( $_POST[ 'fishing-beat6-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishing-beat6-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishing-beat6-checkbox', '' );
		}
