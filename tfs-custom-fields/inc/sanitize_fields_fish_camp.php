...
function sbm_fish_camp_meta_save( $post_id ) {
	...
	// Checks for input and displays sping section
		if( isset( $_POST[ 'fishcamp-dates-readmore-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishcamp-dates-readmore-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishcamp-dates-readmore-checkbox', '' );
		}
	...
	// Checks for input and displays sping section
		if( isset( $_POST[ 'fishcamp-lodging-readmore-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishcamp-lodging-readmore-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishcamp-lodging-readmore-checkbox', '' );
		}
	...
	// Checks for input and displays sping section
		if( isset( $_POST[ 'fishcamp-gettingto-readmore-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishcamp-gettingto-readmore-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishcamp-gettingto-readmore-checkbox', '' );
		}
	
	// Checks for input and displays sping section
		if( isset( $_POST[ 'fishcamp-itinerary-readmore-checkbox' ] ) ) {
				update_post_meta( $post_id, 'fishcamp-itinerary-readmore-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'fishcamp-itinerary-readmore-checkbox', '' );
		}
