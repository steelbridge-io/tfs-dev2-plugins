...
    </p>
    
    <p> <!-- ==== RESERVATIONS-RATES / GUIDE SERVICE VIDEO/IMAGE OPTION ==== -->

		<span class="guideservice-row-title"><?php _e( '<strong>Image or Video?</strong>', 'guideservice-textdomain' )?></span>
		<div class="guideservice-row-content">
		<label for="feature-gs1-checkbox">
		<input type="checkbox" name="feature-gs1-checkbox" id="feature-gs1-checkbox" value="yes" <?php if ( isset ( $guideservice_stored_meta['feature-gs1-checkbox'] ) ) checked( $guideservice_stored_meta['feature-gs1-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video. Leave unchecked for image.', 'guideservice-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
    <p> <!-- ==== SEASONS / GUIDE SERVICE VIDEO/IMAGE OPTION ==== -->

		<span class="guideservice-row-title"><?php _e( '<strong>Image or Video?</strong>', 'guideservice-textdomain' )?></span>
		<div class="guideservice-row-content">
		<label for="feature-gs2-checkbox">
		<input type="checkbox" name="feature-gs2-checkbox" id="feature-gs2-checkbox" value="yes" <?php if ( isset ( $guideservice_stored_meta['feature-gs2-checkbox'] ) ) checked( $guideservice_stored_meta['feature-gs2-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'guideservice-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== FISHING / GETTING TO VIDEO/IMAGE OPTION ==== -->

		<span class="guideservice-row-title"><?php _e( '<strong>Image or Video?</strong>', 'guideservice-textdomain' )?></span>
		<div class="guideservice-row-content">
		<label for="feature-gs3-checkbox">
		<input type="checkbox" name="feature-gs3-checkbox" id="feature-gs3-checkbox" value="yes" <?php if ( isset ( $guideservice_stored_meta['feature-gs3-checkbox'] ) ) checked( $guideservice_stored_meta['feature-gs3-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'guideservice-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== LODGING / LODGING VIDEO/IMAGE OPTION ==== -->

		<span class="guideservice-row-title"><?php _e( '<strong>Image or Video?</strong>', 'guideservice-textdomain' )?></span>
		<div class="guideservice-row-content">
		<label for="feature-gs4-checkbox">
		<input type="checkbox" name="feature-gs4-checkbox" id="feature-gs4-checkbox" value="yes" <?php if ( isset ( $guideservice_stored_meta['feature-gs4-checkbox'] ) ) checked( $guideservice_stored_meta['feature-gs4-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'guideservice-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== GETTING THERE / FISHING VIDEO/IMAGE OPTION ==== -->

		<span class="guideservice-row-title"><?php _e( '<strong>Image or Video?</strong>', 'guideservice-textdomain' )?></span>
		<div class="guideservice-row-content">
		<label for="feature-gs5-checkbox">
		<input type="checkbox" name="feature-gs5-checkbox" id="feature-gs5-checkbox" value="yes" <?php if ( isset ( $guideservice_stored_meta['feature-gs5-checkbox'] ) ) checked( $guideservice_stored_meta['feature-gs5-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'guideservice-textdomain' )?>
		</label>
		</label>
		</div>
