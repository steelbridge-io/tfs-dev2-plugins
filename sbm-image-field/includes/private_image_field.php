...
    </p>
    
    <p> <!-- ==== FEATURE #1 / PRIVATE VIDEO/IMAGE OPTION ==== -->

		<span class="private-row-title"><?php _e( '<strong>Image or Video?</strong>', 'private-textdomain' )?></span>
		<div class="private-row-content">
		<label for="feature-pw1-checkbox">
		<input type="checkbox" name="feature-pw1-checkbox" id="feature-pw1-checkbox" value="yes" <?php if ( isset ( $private_stored_meta['feature-pw1-checkbox'] ) ) checked( $private_stored_meta['feature-pw1-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video. Leave unchecked for image.', 'private-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
		...
		<p> <!-- ==== FEATURE #2 / TAVEL VIDEO/IMAGE OPTION ==== -->

		<span class="private-row-title"><?php _e( '<strong>Image or Video?</strong>', 'private-textdomain' )?></span>
		<div class="private-row-content">
		<label for="feature-pw2-checkbox">
		<input type="checkbox" name="feature-pw2-checkbox" id="feature-pw2-checkbox" value="yes" <?php if ( isset ( $private_stored_meta['feature-pw2-checkbox'] ) ) checked( $private_stored_meta['feature-pw2-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'private-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== FEATURE #3 / GETTING TO VIDEO/IMAGE OPTION ==== -->

		<span class="private-row-title"><?php _e( '<strong>Image or Video?</strong>', 'private-textdomain' )?></span>
		<div class="private-row-content">
		<label for="feature-pw3-checkbox">
		<input type="checkbox" name="feature-pw3-checkbox" id="feature-pw3-checkbox" value="yes" <?php if ( isset ( $private_stored_meta['feature-pw3-checkbox'] ) ) checked( $private_stored_meta['feature-pw3-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'private-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== FEATURE #4 / LODGING VIDEO/IMAGE OPTION ==== -->

		<span class="private-row-title"><?php _e( '<strong>Image or Video?</strong>', 'private-textdomain' )?></span>
		<div class="private-row-content">
		<label for="feature-pw4-checkbox">
		<input type="checkbox" name="feature-pw4-checkbox" id="feature-pw4-checkbox" value="yes" <?php if ( isset ( $private_stored_meta['feature-pw4-checkbox'] ) ) checked( $private_stored_meta['feature-pw4-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'private-textdomain' )?>
		</label>
		</label>
		</div>
...
    </p>
    
		<p> <!-- ==== FEATURE #5 / FISHING VIDEO/IMAGE OPTION ==== -->

		<span class="private-row-title"><?php _e( '<strong>Image or Video?</strong>', 'private-textdomain' )?></span>
		<div class="private-row-content">
		<label for="feature-pw5-checkbox">
		<input type="checkbox" name="feature-pw5-checkbox" id="feature-pw5-checkbox" value="yes" <?php if ( isset ( $private_stored_meta['feature-pw5-checkbox'] ) ) checked( $private_stored_meta['feature-pw5-checkbox'][0], 'yes' ); ?> />
		<?php _e( 'Check box if you are importing video.', 'private-textdomain' )?>
		</label>
		</label>
		</div>
...
/* ==== Loads the image management javascript using wp enqueue media ==== */
 /*function private_image_enqueue() {
    global $typenow;
    if( $typenow == 'post' or 'page' or 'private_posts' ) {
        wp_enqueue_media();
        ...
        wp_localize_script( 'meta-box-image', 'meta_image', 
            array(
                'title' => __( 'Choose or Upload an Image', 'private-textdomain' ),
                'button' => __( 'Use this image', 'private-textdomain' ),
            )
        );
        wp_enqueue_script( 'meta-box-image' );
    }
}
add_action( 'admin_enqueue_scripts', 'private_image_enqueue' );*/
