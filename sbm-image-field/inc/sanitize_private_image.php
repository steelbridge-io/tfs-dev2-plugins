...
function private_meta_save( $post_id ) {
	...
	// Checks for input and saves
		if( isset( $_POST[ 'feature-pw1-checkbox' ] ) ) {
				update_post_meta( $post_id, 'feature-pw1-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'feature-pw1-checkbox', '' );
		}
  ...
  // Checks for input and saves
  	if( isset( $_POST[ 'feature-pw2-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-pw2-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-pw2-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-pw3-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-pw3-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-pw3-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-pw4-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-pw4-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-pw4-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-pw5-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-pw5-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-pw5-checkbox', '' );
  	}
