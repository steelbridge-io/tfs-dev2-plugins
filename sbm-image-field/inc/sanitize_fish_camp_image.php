...
function fish_camp_meta_save( $post_id ) {
	...
	// Checks for input and saves
		if( isset( $_POST[ 'feature-fc1-checkbox' ] ) ) {
				update_post_meta( $post_id, 'feature-fc1-checkbox', 'yes' );
		} else {
				update_post_meta( $post_id, 'feature-fc1-checkbox', '' );
		}
  ...
  // Checks for input and saves
  	if( isset( $_POST[ 'feature-fc2-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-fc2-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-fc2-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-fc3-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-fc3-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-fc3-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-fc4-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-fc4-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-fc4-checkbox', '' );
  	}
  ...
  // Checks for input and saves if needed
	...
	// Checks for input and saves
  	if( isset( $_POST[ 'feature-fc5-checkbox' ] ) ) {
  			update_post_meta( $post_id, 'feature-fc5-checkbox', 'yes' );
		} else {
  			update_post_meta( $post_id, 'feature-fc5-checkbox', '' );
  	}
